...
const PaymentPage = () => {
  return (
    <>
      <SEO
        title="Оплата — LUNÉ"
        description="Доступні способи оплати замовлень у магазині срібних прикрас LUNÉ."
      />
      <Section>
        <Container>
          <SectionTitle
          ...
          <div className="mt-16 grid gap-8 lg:grid-cols-2">
            ...
            <div className="rounded-3xl border border-stone-200 bg-white p-8 transition-all duration-300 hover:-translate-y-1 hover:shadow-xl">
              ...
              <p className="mt-4 leading-8 text-stone-600">
                Ви можете оплатити повну вартість замовлення на банківську
                картку. Після підтвердження платежу ми одразу готуємо ваше
                замовлення до відправлення.
              </p>
          ...
          <div className="mt-12 rounded-3xl border border-stone-200 bg-white p-10 text-center">
            ...
            <p className="mx-auto mt-5 max-w-2xl leading-8 text-stone-600">
              Після оформлення ми зв'язуємося з вами для підтвердження
              замовлення. Після відправлення ви отримуєте номер ТТН для
              відстеження посилки.
            </p>
          </div>
